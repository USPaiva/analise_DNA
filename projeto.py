...
while t<1:
    ...
    ff2=len(LG2TTUF)
    if o<o2:
        tt=(len(LG2TTUF)/o2)*100
    else:
       tt=(len(LG1TTUF)/o)*100
    if len(LG110F) == 0:
    ...
    print(ff2)
    print("########################################################")
    print("%","de bases nitrogenadas diferentes das duas amostras:")
    print(tt,"%")
    print("########################################################")
...
###############################################################################
    ...
    arq.close()
###############################################################################
    arq=open("analise_unitaria_{}.txt".format(g),"w")
    arq.write(str("elemento"+"\t"+"DNA1"+"\t"+"DNA2"+"\n"))
    while i<len(LG2TTUF):
        arq.write(str(E[i]+"\t"+LG1TTUF[i]+"\t"+LG2TTUF[i]+"\n"))
        i=i+1
    arq.close()
###############################################################################
